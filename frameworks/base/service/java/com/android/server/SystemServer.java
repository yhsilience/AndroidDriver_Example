...
import com.android.server.SpGpioService;
...
public final class SystemServer {
    ...
    private void run() {
        ...
        try {
            Slog.i("System", "add the SpGpioService");
            ServiceManager.addService("GpioCtrl",new SpGpioService());
        }catch (Throwable e){
            Slog.e("System", "failed to add the SpGpioService");
        }
        // Start services.
        try {
